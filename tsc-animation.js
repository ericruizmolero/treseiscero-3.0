...
// ══════════════════════════════════════════════════════════════════
//  CONFIGURACIÓN FINAL (TUS VALORES)
// ══════════════════════════════════════════════════════════════════
...
//  SVG MASK
// ══════════════════════════════════════════════════════════════════
const SVG_SRC = `<svg width="123" height="18" viewBox="0 0 123 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M109.082 11.0681C109.082 6.89596 111.757 4.14233 115.682 4.14233C119.607 4.14233 122.281 6.89596 122.281 11.0681C122.281 15.2403 119.601 17.9999 115.682 17.9999C111.757 17.9999 109.082 15.2403 109.082 11.0681ZM112.111 11.0681C112.111 13.7502 113.458 15.3535 115.688 15.3535C117.912 15.3535 119.252 13.7562 119.252 11.0681C119.252 8.38006 117.912 6.78868 115.688 6.78868C113.458 6.78868 112.111 8.38602 112.111 11.0681Z" fill="#022D42"/><path d="M103.625 11.3843V17.6426H100.607V4.50024H103.625V8.88102C104.172 6.16315 105.71 4.50024 108.409 4.50024H109.106V7.33136H108.109C104.695 7.33136 103.625 8.63069 103.625 11.3843Z" fill="#022D42"/><path d="M96.9155 13.2377H99.8246C99.1214 16.2058 96.7653 17.9999 93.6037 17.9999C89.6547 17.9999 86.998 15.2045 86.998 11.0562C86.998 6.9198 89.6247 4.14233 93.5316 4.14233C97.3843 4.14233 99.8847 6.84828 99.8847 11.0264C99.8847 11.3363 99.8727 11.6403 99.8367 11.98H89.9793C90.2317 14.1674 91.5961 15.4787 93.6818 15.4787C95.2626 15.4787 96.3265 14.7218 96.9155 13.2377ZM90.0214 9.83436H96.8975C96.5789 7.75424 95.4189 6.63967 93.5436 6.63967C91.6202 6.63967 90.352 7.8198 90.0214 9.83436Z" fill="#022D42"/><path d="M67.1078 4.14233C70.8644 4.14233 73.0162 5.85292 73.0162 8.59463H70.053C70.053 7.31318 69.0312 6.49067 67.1439 6.49067C65.4669 6.49067 64.3129 7.14033 64.3129 8.11185C64.3129 9.25025 65.8095 9.48866 67.2821 9.72707L68.1657 9.87012C70.3415 10.2218 73.461 10.7284 73.461 13.8933C73.461 16.5098 71.3092 17.9999 67.3723 17.9999C63.249 17.9999 61.1152 16.3668 61.1152 13.4403H64.0785C64.0785 14.8588 65.1303 15.6396 67.3542 15.6396C69.3317 15.6396 70.5038 15.0257 70.5038 13.9469C70.5038 12.6714 68.9711 12.3973 67.2641 12.1052L66.3745 11.9562C64.397 11.6105 61.3557 11.1039 61.3557 8.17145C61.3557 5.69795 63.5255 4.14233 67.1078 4.14233Z" fill="#022D42"/><path d="M76.7559 11.0681C76.7559 13.7502 78.1023 15.3535 80.3322 15.3535C82.2496 15.3535 83.2594 14.1496 83.5599 12.5701H86.5712C86.1685 15.6873 83.8784 17.9999 80.3262 17.9999C76.4073 17.9999 73.7266 15.2403 73.7266 11.0681C73.7266 6.89596 76.4013 4.14233 80.3262 4.14233C83.8784 4.14233 86.1685 6.44894 86.5712 9.57211H83.5
// ══════════════════════════════════════════════════════════════════
//  CANVAS SETUP (RESPONSIVE + OVERFLOW FIX)
// ══════════════════════════════════════════════════════════════════
...
// 1. Calculamos tamaño base del logo
...
// 2. EXTRA: Espacio gigante para que no haya rastros y las letras vuelen
const EXTRA = 300 * DPR 

canvas.width  = RENDER_W + (EXTRA * 2)
canvas.height = RENDER_H + (EXTRA * 2)

// 3. Estilos CSS para centrar el canvas expandido sin mover el logo de su sitio
...
// 4. Movemos el pincel al centro (compensamos el EXTRA)
...
function findCenterPhrase() {
  ...
  for (let li = 0; li < lines.length; li++) {
    ...
    while (true) {
      ...
      if (d < bestDist) {
        bestDist = d
        best = { x: xs[idx], y: oy, w: xs[idx+PHRASE.length] - xs[idx], h: lineH, rowIdx: li, charStart: idx, charEnd: idx+PHRASE.length }
      }
      from = idx + 1
    }
  }
  ...
  for (let li = 0; li < lines.length; li++) {
    ...
    for (let ci = 0; ci < text.length; ci++) {
      ...
      if (alpha >= cfg.alphaThresh) {
        raw.push({ ox: x, oy, x, y: oy, vx: 0, vy: 0, ch: text[ci], cw, lineH, color: COLOR_MAIN, cx: sx, rawA: alpha/255, isCentral })
      }
...
function setupBigPhrase(phraseRect, bigFontPx, startX, startY) {
  ...
  bigPhrase = { startTx: startX, startTy: startY, startScale: scale, finalTx: phraseRect.x, finalTy: phraseRect.y }
}
...
function tick(now) {
  ...
  // 🔥 LIMPIEZA TOTAL: Borramos todo el canvas expandido
  ctx.clearRect(-EXTRA, -EXTRA, canvas.width, canvas.height)
  ctx.textBaseline = 'top'

  if (shrinkT < 1) {
    const e = easeInOutCubic(shrinkT), tx = lerp(bigPhrase.startTx, bigPhrase.finalTx, e), ty = lerp(bigPhrase.startTy, bigPhrase.finalTy, e), s = lerp(bigPhrase.startScale, 1, e)
    ctx.save()
    ctx.translate(tx, ty)
    ctx.scale(s, s)
    ...
    const curR = Math.round(lerp(COLOR_MIST.r, COLOR_MAIN.r, e)), curG = Math.round(lerp(COLOR_MIST.g, COLOR_MAIN.g, e)), curB = Math.round(lerp(COLOR_MIST.b, COLOR_MAIN.b, e))
    ctx.fillStyle = `rgb(${curR},${curG},${curB})`
    ctx.fillText(part2, off, 0)
    off += ctx.measureText(part2).width
    ctx.fillStyle = `rgb(${COLOR_MAIN.r},${COLOR_MAIN.g},${COLOR_MAIN.b})`
  ...
  if (elapsed >= shrinkEnd) {
    ...
    for (const p of particles) {
      ...
      if (mouse.active) {
        ...
        if (d2 < 22500 && d2 > 0) {
          const d = Math.sqrt(d2), f = ((150-d)/150)**2 * cfg.cursorForce * 0.5, a = Math.atan2(dy, dx)
